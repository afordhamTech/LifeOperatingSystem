...
export const users = mysqlTable("users", {
  ...
  targetSleepHours: decimal("target_sleep_hours", { precision: 3, scale: 1 }).default("8.0"),
...
export const dailyLogs = mysqlTable("daily_logs", {
  ...
  sleepReadiness: decimal("sleep_readiness", { precision: 4, scale: 2 }),
  workoutReadiness: decimal("workout_readiness", { precision: 4, scale: 2 }),
  academicPriorityScore: decimal("academic_priority_score", { precision: 4, scale: 2 }),
  nutritionStatus: varchar("nutrition_status", { length: 20 }),
  dailyPriorityScore: decimal("daily_priority_score", { precision: 4, scale: 2 }),
...
export const sleepLogs = mysqlTable("sleep_logs", {
  ...
  sleepDebt: decimal("sleep_debt", { precision: 5, scale: 2 }).default("0"),
  readinessScore: decimal("readiness_score", { precision: 4, scale: 2 }),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull().$onUpdate(() => new Date()),
}, (table) => [
...
export const academicTasks = mysqlTable("academic_tasks", {
  ...
  priorityScore: decimal("priority_score", { precision: 4, scale: 2 }),
...
export const workoutLogs = mysqlTable("workout_logs", {
  ...
  bodyweight: int("bodyweight"),
  verticalJump: decimal("vertical_jump", { precision: 4, scale: 1 }),
...
export const healthLogs = mysqlTable("health_logs", {
  ...
  sleep: decimal("sleep", { precision: 4, scale: 2 }),
  ...
  injuryRiskScore: decimal("injury_risk_score", { precision: 4, scale: 2 }),
...
export const careerArtifacts = mysqlTable("career_artifacts", {
  ...
  proofScore: decimal("proof_score", { precision: 4, scale: 2 }),
...
export const moneyLogs = mysqlTable("money_logs", {
  ...
  spending: decimal("spending", { precision: 10, scale: 2 }),
  savings: decimal("savings", { precision: 10, scale: 2 }),
  debt: decimal("debt", { precision: 10, scale: 2 }),
  foodSpending: decimal("food_spending", { precision: 10, scale: 2 }),
  schoolCosts: decimal("school_costs", { precision: 10, scale: 2 }),
  emergencyFund: decimal("emergency_fund", { precision: 10, scale: 2 }),
...
export const faithLogs = mysqlTable("faith_logs", {
  ...
  faithScore: decimal("faith_score", { precision: 5, scale: 2 }),
  createdAt: timestamp("created_at").defaultNow().notNull(),
}, (table) => [
...
export const relationshipLogs = mysqlTable("relationship_logs", {
  ...
  relationshipPriority: decimal("relationship_priority", { precision: 4, scale: 2 }),
  notes: text("notes"),
  createdAt: timestamp("created_at").defaultNow().notNull(),
});
...
export const learningLogs = mysqlTable("learning_logs", {
  ...
  substanceScore: decimal("substance_score", { precision: 4, scale: 2 }),
  createdAt: timestamp("created_at").defaultNow().notNull(),
}, (table) => [
...
export const weeklyReviews = mysqlTable("weekly_reviews", {
  ...
  academicScore: decimal("academic_score", { precision: 4, scale: 2 }),
  sleepScore: decimal("sleep_score", { precision: 4, scale: 2 }),
  trainingScore: decimal("training_score", { precision: 4, scale: 2 }),
  nutritionScore: decimal("nutrition_score", { precision: 4, scale: 2 }),
  careerScore: decimal("career_score", { precision: 4, scale: 2 }),
  faithScore: decimal("faith_score", { precision: 4, scale: 2 }),
  moneyScore: decimal("money_score", { precision: 4, scale: 2 }),
  relationshipScore: decimal("relationship_score", { precision: 4, scale: 2 }),
  weeklyLifeScore: decimal("weekly_life_score", { precision: 4, scale: 2 }),
